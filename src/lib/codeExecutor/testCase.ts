...
import { Judge0Language } from '$lib/types/judge0';
...
class FunctionOutputTestCaseHandler extends TestCase<FunctionOutputTestCase, FunctionOutputTestCaseUpdateArgs['data']> {
...
class ProgramIOTestCaseHandler extends TestCase<ProgramIOTestCase, ProgramIOTestCaseUpdateArgs['data']> {
