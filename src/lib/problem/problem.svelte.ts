...
import { parseExtensionData, type FunctionTestCaseProblemData } from '$lib/testCase/builtin/functionTestCase/types';
...
export class Problem {
  public model = $state() as ProblemModel;
  constructor(model: ProblemModel) {
    this.model = model;
  }
