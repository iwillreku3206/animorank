...
<div class="relative">
	...
	<main class="px-4 xl:px-32 opacity-80">
		...
		<div class="w-full flex flex-col gap-20 justify-center items-center py-8 xl:py-32">
			...
			<BenefitCard title="Problem Sets" image={{ src: '/img/sample-1.png', alt: 'Problem Sets' }}>
				<p>
		...
		<div class="w-full flex flex-col gap-8 justify-center items-center py-8 xl:py-32">
			<h2 class="font-bold text-5xl xl:text-7xl" style="letter-spacing: -4px;">
			...
			{:else}
				<a class="btn bg-primary text-primary-content px-4 py-3" href="/">Dashboard</a>
			{/if}
		</div>
	</main>
</div>
